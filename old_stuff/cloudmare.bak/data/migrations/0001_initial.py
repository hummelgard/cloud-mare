...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, serialize=False, primary_key=True, verbose_name='ID')),
                ('IMEI', models.CharField(verbose_name='IMEI number', help_text='Trackers IMEI number', max_length=200)),
                ('version', models.IntegerField(verbose_name='version', default=0, help_text='revision number of tracker unit')),
        ...
        migrations.AddField(
            ...
            name='tracker',
            field=models.ForeignKey(verbose_name='horse tracker', to='data.HorseTracker'),
        ),
        migrations.AddField(
            model_name='horse',
            name='tracker',
            field=models.ForeignKey(to='data.HorseTracker', help_text='the cloudMARE tracker device used', verbose_name='horse tracker'),
        ),
        migrations.AddField(
            model_name='horse',
            name='user',
