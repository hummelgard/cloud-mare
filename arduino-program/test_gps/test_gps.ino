...
// SoftwareSerial serialGPS(3, 2); -> SoftwareSerial serialGPS(8, 7);
...
void loop()                     // run over and over again
{
  ...
  // 5 meter per 4 decimal i degrees
  lat1 = husLatDegrees;
  ...
  distance= R * c * 1000;
  // distance=1000*5*sqrt((husLongDegrees-GPS.longitudeDegrees)*(husLongDegrees-GPS.longitudeDegrees)+(husLatDegrees-GPS.latitudeDegrees)*(husLatDegrees-GPS.latitudeDegrees));
  ...
  serialLCD.write(192);
  //serialLCD.print("La:");
  serialLCD.print(GPS.latitudeDegrees,4);
  serialLCD.write("/");
  serialLCD.print(GPS.longitudeDegrees,4); 
